...
import { AudioModal } from "@/components/course/AudioModal";
...
export const CourseDetails: React.FC<CourseDetailsProps> = ({ params }) => {
...
---
Generated by ADPLearn - ${new Date().toLocaleDateString()}
    `;
  ...
  const handleStudentClick = (student: any) => {
    // Navigate to peer-review with specific user
    router.push(
      `/peer-review?user=${student.id}&name=${encodeURIComponent(student.name)}`
    );
  };
  ...
  const progressPercentage = (
    (completedLessons / course.videos.length) *
    100
  ).toFixed(0);
    ...
    <div className="max-w-7xl mx-auto p-6 space-y-2">
      ...
      <div className="bg-[#7B61FF] text-white rounded-lg p-3 text-center flex items-center justify-center gap-2">
        ...
        <h2 className="text-sm font-normal">
          Track your progress: {completedLessons}/{course.videos.length} lessons
        ...
        <div className="space-y-6 h-auto border-l border-[#05060F1A] pl-5">
          ...
          <div className="w-full h-auto">
            ...
            <div className="space-y-2 rounded-lg border border-gray-200 p-2">
              {contacts.slice(0, 6).map((student) => (
                <StudentAvatar
                  key={student.id}
                  student={student}
      ...
      <AudioModal
        ...
        lesson={audioState.currentLesson}
      />
